...
document.addEventListener('click', function(e) {
  ...
  const popups = [headingPopup, blockquotePopup, listPopup, textPopup, bgPopup, urlPopup, videoPopup, imagePopup, actionsPopup, palettePopup];
  popups.forEach(popup => {
    if (popup && !popup.classList.contains('d-none')) {
      ...
      const isClickOnTrigger = e.target.id === 'list-btn' || e.target.id === 'align-btn' || e.target.id === 'palette-btn' || e.target.id === 'heading-btn' || e.target.id === 'actions-btn';
